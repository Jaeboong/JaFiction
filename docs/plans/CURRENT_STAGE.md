...
|---------|------|------|--------|----------|
| P1 | 공고 파서 JSON-LD 파싱 + fieldSources 복구 | In Progress — Chunk 1~2 완료 (Chunk 1 `f176c97`, Chunk 2 `fd47ec5`), Chunk 3+4 Codex 진행 중 | feat/p0-posting-parser-field-confidence | [링크](2026-04-19-posting-parser-p1-jsonld.md) |
...
- `feat/p0-posting-parser-field-confidence`: P1 JSON-LD 리팩터 진행 중 (HEAD `fd47ec5`)
